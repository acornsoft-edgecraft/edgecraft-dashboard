  ...
  <div class="partial-container m-0 p-0">
    <K3FormContainer>
      ...
      <K3FormRow class="h-3rem">
        <K3FormColumn>
          <K3FormCheckField v-model="v$.etcd.use_external_etcd"
                            id="use_external_etcd"
                            label="External ETCD" />
        </K3FormColumn>
      </K3FormRow>
      <template v-if="data.etcd.use_external_etcd">
              ...
              <K3ValidateEach v-for="(item, index) in data.etcd.endpoints"
                ...
                <template #default="{ v }">
                  <K3FormRow direction="horizontal"
                             :overflow-wrap="true">
                    <K3FormColumn>
                      <K3FormInputField v-model="v.ip_address"
                                        field-name="IP Address"
                                        placeholder="IP Address" />
                      <span class="mx-2">:</span>
                      <K3FormInputField v-model="v.port"
                                        field-name="Port"
                                        placeholder="Port" />
        ...
        <K3FormRow>
          <K3FormColumn label="CA File"
                        label-align="right">
            <K3FormInputField v-model="v$.etcd.ca_file"
                              field-name="CA File"
                              class="w-full" />
          </K3FormColumn>
        </K3FormRow>
        <K3FormRow>
          <K3FormColumn label="CERT File"
                        label-align="right">
            <K3FormInputField v-model="v$.etcd.cert_file"
                              field-name="CERT File"
                              class="w-full" />
          </K3FormColumn>
        </K3FormRow>
        <K3FormRow>
          <K3FormColumn label="KEY File"
                        label-align="right">
            <K3FormInputField v-model="v$.etcd.key_file"
                              field-name="KEY File"
                              class="w-full" />
          </K3FormColumn>
        </K3FormRow>
    ...
    <K3FormContainer>
      ...
      <K3FormRow class="h-3rem">
        <K3FormColumn>
          <K3FormCheckField v-model="v$.storage_class.use_ceph"
                            id="use_ceph"
                            label="Use Ceph" />
        </K3FormColumn>
      </K3FormRow>
      <template v-if="data.storage_class.use_ceph">
        <K3FormRow>
          <K3FormColumn label="Label 1"
                        label-align="right">
            <K3FormInputField v-model="v$.storage_class.label1"
                              field-name="Label1"
                              class="w-full" />
          </K3FormColumn>
        </K3FormRow>
        <K3FormRow>
          <K3FormColumn label="Label 2"
                        label-align="right">
            <K3FormInputField v-model="v$.storage_class.label2"
                              field-name="Label2"
                              class="w-full" />
          </K3FormColumn>
        </K3FormRow>
        <K3FormRow>
          <K3FormColumn label="Label 3"
                        label-align="right">
            <K3FormInputField v-model="v$.storage_class.label3"
                              field-name="Label3"
                              class="w-full" />
          </K3FormColumn>
        </K3FormRow>
