                ...
                <div class="p-fluid formgrid grid">
                    ...
                    <div class="field-checkbox col-12">
                        <Checkbox id="remember"
                                  ...
                                  :binary="true" />
                        <label for="remember"
                               class="p-checkbox-label">Save credit card information for future</label>
                    </div>
                </div>
            </template>
...
<script setup>
definePageMeta({ layout: 'default', title: 'Payment Step', public: true })
</script>
