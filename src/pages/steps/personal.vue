            ...
            <template v-slot:content>
                <div class="p-fluid">
                    <div class="field">
                        ...
                        <small v-show="validationErrors.firstname && submitted"
                               class="p-error">Firstname is required.</small>
                    </div>
                    <div class="field">
                        ...
                        <small v-show="validationErrors.lastname && submitted"
                               class="p-error">Lastname is required.</small>
                    </div>
                    <div class="field">
...
<script setup>
definePageMeta({ layout: 'default', title: 'Personal Step', public: true })
</script>
