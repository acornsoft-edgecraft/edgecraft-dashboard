<template>
  <div class="item-container">
    <div class="form-field">
      <K3Dropdown v-model="modelValue.$model" :options="options" :option-label="optionLabel" :option-value="optionValue" :class="itemClass" @change="onChange" @focus="onFocus" @blur="onBlur" @before-show="onBeforeShow" @before-hide="onBeforeHide" @show="onShow" @hide="onHide" @filter="onFilter" />
    </div>
